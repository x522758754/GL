...
class multipleLights : public app
{
	...
	void render(double time)
	{
		...
		shader.setVec3("pointLights[0].diffuse", glm::vec3(0.5f, 0.5f, 0.5f)); // 将光照调暗了一些以搭配场景
		...
		shader.setVec3("pointLights[1].diffuse", glm::vec3(0.5f, 0.5f, 0.5f)); // 将光照调暗了一些以搭配场景
		...
		shader.setVec3("spotLight.diffuse", glm::vec3(0.88f, 0.8f, 0.f)); // 将光照调暗了一些以搭配场景
